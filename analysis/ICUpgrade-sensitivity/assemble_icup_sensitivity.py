#!/usr/bin/env python3
"""
Assemble IceCube Upgrade Sensitivity Scan Results from Array Job Row Files
...
Usage:
    python assemble_icup_sensitivity.py --input-dir DIR [--output-dir DIR]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Assemble ICUp sensitivity grid from row results")
    ...
    print("=" * 70)
    print("ASSEMBLING ICECUBE UPGRADE SENSITIVITY SCAN RESULTS")
    print("=" * 70)
