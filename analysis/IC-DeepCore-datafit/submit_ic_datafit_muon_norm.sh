#!/bin/bash
#SBATCH -J ic_mn_data
#SBATCH -o logs/ic_mn_data_%a_%j.out
#SBATCH -e logs/ic_mn_data_%a_%j.err
#SBATCH -c 4
#SBATCH --mem=16G
#SBATCH -t 0-02:00
...
OUTPUT_DIR=${OUTPUT_DIR:-${SCRIPT_DIR}/results/ic_datafit_muon_norm_41x41/rows}
mkdir -p ${OUTPUT_DIR}
mkdir -p logs
...
python -u ${SCRIPT_DIR}/run_ic_datafit_row_worker.py \
    ...
    --n-dm 41 --n-s23 41 \
    --config ${SCRIPT_DIR}/IC_Atm_datafit_muon_norm.xml \
