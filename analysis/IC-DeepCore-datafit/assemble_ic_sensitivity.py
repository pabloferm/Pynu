#!/usr/bin/env python3
"""
Assemble IceCube DeepCore Sensitivity Scan Results from Array Job Row Files
...
Usage:
    python assemble_ic_sensitivity.py --input-dir DIR [--output-dir DIR]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Assemble IC sensitivity grid from row results")
    ...
    print("=" * 70)
    print("ASSEMBLING IC DEEPCORE SENSITIVITY SCAN RESULTS")
    print("=" * 70)
    ...
    # Dm231 profile (marginalized over Sin2Theta23)
    ...
    # Sin2Theta23 profile (marginalized over Dm231)
