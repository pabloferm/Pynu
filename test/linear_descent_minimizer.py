...
def linear_gradient_descent_minimizer(fn, gradient_fn, initial_point, precission=1e-4, num_iterations=10000, bounds=None):
    point = initial_point
    loop_counter = 0
    in_bounds = False
...
minimized_point = linear_gradient_descent_minimizer(function_to_minimize, gradient_function, initial_point, bounds=bounds)
