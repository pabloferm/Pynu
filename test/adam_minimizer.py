...
def adam_minimizer(parameters, gradient, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8, precission=1e-4, num_iterations=100, bounds=None):
...
minimized_point = adam_minimizer(initial_point, gradient_function, learning_rate=learning_rate)
