...
variables = {
    ...
    'azi': azi,
    'cz': cz,
    'fluxho_nue': fluxho_nue,
    'fluxho_nueb': fluxho_nueb,
    'fluxho_numu': fluxho_numu,
    'fluxho_numub': fluxho_numub,
    'plep': plep,
    'dirlepX': dirlepX,
    'dirlepY': dirlepY,
    'dirlepZ': dirlepZ,
    ...
    'mode': mode,
    'weightSim': weightSim,
    'weightOsc_SKpaper': weightOsc_SKpaper,
    'weightOsc_SKbest': weightOsc_SKbest,
    'weightReco': weightReco}
